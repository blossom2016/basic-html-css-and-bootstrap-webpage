...
<body>
    ...
    <div class="container">
        <h1>Want to get in touch with us? Then send us a message</h1>
        ...
        <form method="post">
            <fieldset class="form-group">
                ...
                <small class="text-muted">We promise we'll never share or spam your email.</small>
            </fieldset>
            ...
            <button type="submit" class="btn btn-primary"><mailto: ebube_williams@yahoo.com>Submit</button>
